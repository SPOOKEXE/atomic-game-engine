...
//
// **Content, and not part of `Engine::nodegraph`, said out loud.** This is the
...
// reason - a host with its own node vocabulary links `Engine::nodegraph` and
...
namespace studio {
	...
	void BuildDemoGraph(engine::nodegraph::Graph &graph);
}
