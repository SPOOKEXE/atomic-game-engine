	...
	namespace {
		...
		constexpr std::array<Keybind, static_cast<size_t>(Action::Count)> DEFAULTS{{
			...
			{Action::ToolSelect,
			 "tool.select",
			 "Select Tool",
			 "Click to select, with no handles",
			 Scope::Viewport,
			 {}},
			{Action::ToolMove,
			 "tool.move",
			 "Move Tool",
			 "Drag an axis to move the selection",
			 Scope::Viewport,
			 {}},
			{Action::ToolRotate,
			 "tool.rotate",
			 "Rotate Tool",
			 "Drag a ring to turn the selection",
			 Scope::Viewport,
			 {}},
			{Action::ToolScale,
			 "tool.scale",
			 "Scale Tool",
			 "Drag an axis to resize the selection",
			 Scope::Viewport,
			 {}},
			...
			{Action::ShowStatistics,
			 "panel.statistics",
			 "Statistics",
			 "Show the frame rate panel",
			 Scope::Global,
			 {}},
			{Action::ShowFrameGraph,
			 "panel.framegraph",
			 "Frame Graph",
			 "Show where the frame went",
			 Scope::Global,
			 {}},
