...
| `scene.Sound` | 24 | 4 | yes | . | . | . | What a sound is rather than a sound playing: asset name, volume, stereo pan, roll-off distances, looped and playing. The client's mixer walks these rows every frame. |
