...
TEST_CASE("EF and Q field samples match TornadoSim reference fixtures", "[scene][storm]") {
	...
	constexpr std::array FIXTURES{
		Fixture{11.283473f, 4.115903f, 2.906791f, {10.024008f, .651069f, 13.142146f}, .011479f},
		Fixture{20.800848f, 8.009912f, 6.860350f, {14.329248f, 4.107254f, 23.578329f}, .040144f},
		Fixture{34.006016f, 13.940103f, 13.719780f, {19.535351f, 10.269013f, 38.511238f}, .110478f},
		Fixture{50.757362f, 22.033022f, 24.185247f, {25.786077f, 19.691429f, 57.901539f}, .252132f},
		Fixture{71.638649f, 32.953224f, 38.834202f, {33.179909f, 33.213676f, 82.376328f}, .514465f},
		Fixture{97.362549f, 46.501331f, 58.281773f, {42.642582f, 51.262539f, 112.548340f}, .966283f},
