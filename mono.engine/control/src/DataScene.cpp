...
namespace engine::control {
	...
	namespace data_scene_detail {
		...
		json Result(const script::DataSceneResult &result, std::string &failure) {
			json converted;
			size_t bytes = 0;
	...
	namespace features {
		Tool CameraRenderingDataTool(world::Universe &universe, world::DataFactorySession *session) {
	...
	void Surface::AddDataSceneTools(
