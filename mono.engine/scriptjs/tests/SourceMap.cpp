...
TEST_SUITE_ID("engine.scriptjs.sourcemap")
// A map is only read when a stack frame is, and a frame comes out of a running
// chunk. Rerun this when the VM that produces one changes.
TEST_DEPENDS("engine.scriptjs.runtime")
