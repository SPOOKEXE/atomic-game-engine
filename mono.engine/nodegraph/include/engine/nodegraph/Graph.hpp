...
namespace engine::nodegraph {
	...
	struct Node {
		...
		//@{
		std::vector<engine::nodegraph::Proxy> Proxies;
		std::vector<engine::nodegraph::Promotion> Promoted;
		//@}
	...
	class Graph {
	  public:
		...
		//@{
		const std::vector<engine::nodegraph::Group> &Groups() const {
			return Frames;
		}
		std::vector<engine::nodegraph::Group> &Groups() {
			return Frames;
		}
		//@}
		...
		//@{
		engine::nodegraph::Group *FindGroup(GroupId group);
		const engine::nodegraph::Group *FindGroup(GroupId group) const;
		//@}
	  ...
	  private:
		...
		std::vector<engine::nodegraph::Group> Frames;
