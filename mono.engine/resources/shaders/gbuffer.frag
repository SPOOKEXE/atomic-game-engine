...
void main() {
	...
	outMaterial = vec4(clamp(roughness, 0.045, 1.0), clamp(metalness, 0.0, 1.0), materialOcclusion, clamp(lighting.MaterialExtra.z, 0.0, 1.0));
	outEmissive = vec4(emissive, clamp(lighting.MaterialExtra.w, 0.0, 1.0));
