...
#define ENGINE_PROFILE_CONCAT(a, b) ENGINE_PROFILE_CONCAT_(a, b)
	...
	#define ENGINE_PROFILE_DYNAMIC(fallback, view, category)                                     \
		...
		::engine::core::FrameGraph::CopiedScope ENGINE_PROFILE_CONCAT(engineProfileScope_,        \
			__LINE__) { fallback, view, category }
...
#define ENGINE_PROFILE_COLLECTING() \
	(ENGINE_PROFILE_ATTACHED() || ::engine::core::FrameGraph::IsEnabled())
