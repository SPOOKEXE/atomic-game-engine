...
- [_] Do cleanup in `docs/v025-RENDER-PIPELINE-CLEANUP.md`. Extracted owners exist; `PortalImageRuntime` still calls `Renderer` directly. The full GPU gate passes.
