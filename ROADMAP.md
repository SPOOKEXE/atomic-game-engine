...
- [_] make step plus snapshot plus multicamera capture atomic, with asynchronous readback completion. The retained one-camera scene sidecar does not complete this item: step and capture remain separate, and multicamera atomicity remains open.
