...
- [_] discord rich presence (https://docs.discord.com/developers/discord-social-sdk/getting-started/using-c++) under preferences to set it up as a tab "Discord Presence"
- [_] deferred item catch up
