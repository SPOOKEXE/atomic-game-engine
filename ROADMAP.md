...
- [_] deferred `D00112`: traversal needs v0.15's character controller to have a body to move, and the one-frame seam on crossing needs the surface pass to recurse in-frame
...
- [_] very basic character controls (WASD, SPACE)
