...
- [_] add optional packed HDR or motion encodings and uint16 depth. Uint16 depth requires recorded scale, offset, valid range, invalid sentinel and maximum reconstruction error; packed HDR and motion require measured encodings and numeric error evidence against native captures.
